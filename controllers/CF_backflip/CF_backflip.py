...
from ruta_predefinida import backflip
...
if __name__ == '__main__':
    ...
    while robot.step(timestep) != -1:
        ...
        # direction = RutaPredefinida.WallFollowingDirection.LEFT
        # range_side_value = range_right_value

        # Get the velocity commands from the wall following state machine
        cmd_vel_x, cmd_vel_y, cmd_ang_w, pitch_desired = backflip(roll, pitch, yaw_rate,
                                        altitude)
